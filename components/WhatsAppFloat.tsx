...
export function WhatsAppFloat() {
  ...
  return (
    ...
    >
      ...
      <div className="relative w-14 h-14 bg-[#25D366] hover:bg-[#1FAE52] rounded-full flex items-center justify-center shadow-2xl shadow-green-500/40 group-hover:scale-110 transition-transform">
